...
void manual(){
	...
	printf("'p n' or 'P n' - to play n rounds in greedy mode\n");
	printf("'m' or 'M' for manual\n");
	printf("'g n' or 'G n' to play n rounds of the game in interactive mode\n");
	printf("'a n' or 'A n' to play n rounds of the game in automatic mode(when its placement phase it'll place n penguins for each player)\n");
